...
Hybrid BM25 + FAISS retrieval · 8-stage guardrails · AWS Bedrock Claude Sonnet
"""
...
app = FastAPI(
    ...
    description="Hybrid BM25 + FAISS retrieval · 8-stage guardrails · AWS Bedrock Claude Sonnet",
    version="2.0.0",
    lifespan=lifespan,
)
